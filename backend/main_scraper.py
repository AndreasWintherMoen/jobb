...
from online import get_event_list, event_is_in_the_future, add_attendance_event_data_to_event
...
def discover_new_bedpres_and_add_to_database(data, context):
    ...
    events = [add_attendance_event_data_to_event(event) for event in events]
